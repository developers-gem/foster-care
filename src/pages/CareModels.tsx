...
const CareModels = () => (
  <div className="min-h-screen">
    ...
    <PageHero
      ...
      description="Not all children have the same needs. ResiPilot supports all types of care — ensuring the right environment for every child."
    ...
    <SectionBlock bg="warm" badge="Residential" title="Group Homes (Residential Care)" description="Specialized care for children with complex behavioral or medical needs.">
      <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        <FeatureCard icon={Building2} title="Staff Coordination" description="ResiPilot helps coordinate care teams across shifts and departments." index={0} />
    ...
    <SectionBlock bg="warm" badge="Platform" title="How ResiPilot Supports Every Model" description="Regardless of care model, ResiPilot provides the tools you need.">
      <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
    ...
    <PageCTA title="Build Better Futures with ResiPilot" description="Every child deserves the right care model. Let us help you deliver it." primaryLabel="Get Started" secondaryLabel="Learn More" />
    <Footer />
  </div>
);
